...
/// <c>Vt2ModManager.exe.new</c> next to the running exe, verify SHA256, rename the
/// running exe to <c>Vt2ModManager.exe.old</c>, then move <c>.new</c> into the running
...
public sealed class UpdateInstaller
{
    ...
    /// <summary>
    /// Best-effort cleanup of <c>Vt2ModManager.exe.old</c> and <c>.new</c> siblings of
